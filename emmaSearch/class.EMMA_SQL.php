	...
	function compose_DELTA_LEX_info($code_internal) {
		...
		$del_lex = '';
	  	...
	  	if ( preg_match("/DELTAGEN/", $code_internal) ){
			...
			$del_lex = "<p><a href='" . $this->drupalFilePath  . "/deltagen/$code_internal' target='_blank'>"
			...
			$del_lex ="<p><a href='" . $this->drupalFilePath . "/lexicon/combined_lexicon_data/${short_lex}-treeFrame.html' "
            ...
            if ( $KV['val'] && $KV['baseUrl'] ){
                ...
                if ( $name == 'mgiLink' ){
                    ...
                    if ( $name == 'mta' and $class == 'grayout' ){
                        ...
                        $toolTip = "<span class='instantToolTip'>Genotyping protocol not available online</span>";                     
                    } 
                    else if ( $name == 'availabilities' and $class == 'grayout' ){
                        $toolTip = "<span class='instantToolTip'>Strain under development</span>";                     
                    } 
